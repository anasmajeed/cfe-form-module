    ...
    <div class="card shadow p-3 w-100">
        <div class="card-body ">
            ...
            <div class="card shadow p-3 w-100">
                <div class="card-body ">
                    <div class="form-row">
                        ...
                        <div class="form-group  col-md-4">
                            <label><strong>Attested by Gazetted Officer:</strong></label>
                            <label>
            ...
            <div class="form-row mt-4 ml-1">
                <div class="form-group  col-md-4">
                    <label><strong>NOC From Previous Affiliated Body(Original):</strong></label>
                    <label>
                        {{$data && $data['document_attachment_details']['noc_affiliated_body'] ? $data['document_attachment_details']['noc_affiliated_body'] : '--'}}
                    </label>
                </div>
                <div class="form-group  col-md-4">
                    <label><strong>Equivalence Certificate(Original):</strong></label>
                    <label>
                ...
                <div class="card-body ">
                    <div class="form-row">
                        ...
                        <div class="form-group  col-md-3">
                            <label><strong>Signed by Principal:</strong></label>
                            <label>
