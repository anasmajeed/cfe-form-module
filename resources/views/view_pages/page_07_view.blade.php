                ...
                <div class="card shadow p-3 w-100">
                    <div class="card-body ">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                <label @if( !$data['bise_details']['bise_roll_no']) class="text-danger" @endif><strong>Roll No:</strong></label>
                                <label>
                                    {{$data && $data['bise_details']['bise_roll_no'] ? $data['bise_details']['bise_roll_no'] : '--'}}
                                </label>
                            </div>
                            <div class="form-group col-md-4">
                                <label @if( !$data['bise_details']['bise_affiliated_body']) class="text-danger" @endif><strong>Affiliated Body:</strong></label>
                                <label>
                ...
                <div class="card shadow p-3 w-100">
                    <div class="card-body ">
                        <div class="form-row">
                            ...
                            <div class="form-group  col-md-4">
                                <label @if( !$data['ims_details']['ims_course_enrolled_in_cfe']) class="text-danger" @endif><strong>Course Enrolled in CFE:</strong></label>
                                <label>
                                    {{$data && $data['ims_details']['ims_course_enrolled_in_cfe'] ? $data['ims_details']['ims_course_enrolled_in_cfe'] : '--'}}
                                </label>
                            </div>
                            <div class="form-group  col-md-4">
                                <label @if( !$data['ims_details']['ims_course_registered']) class="text-danger" @endif><strong>Course Registered in:</strong></label>
                                <label>
                        ...
                        <div class="form-row">
                            <div class="form-group  col-md-4">
                                <label @if( !$data['ims_details']['ims_roll_no']) class="text-danger" @endif><strong>Roll No:</strong></label>
                                <label>
            ...
            <div id="wing_div_af">
                ...
                <div class="card shadow p-3 w-100">
                    <div class="card-body ">
                        ...
                        <div class="form-row">
                            <div class="form-group  col-md-4">
                                <label @if( !$data['af_details']['af_roll_no']) class="text-danger" @endif><strong>Roll No:</strong></label>
                                <label>
                ...
                <div class="card shadow p-3 w-100">
                    <div class="card-body ">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group  col-md-3">
                                <label @if( !$data['vti_details']['vti_roll_no']) class="text-danger" @endif><strong>Roll No:</strong></label>
                                <label>
                        ...
                        <div class="form-row">
                            <div class="form-group  col-md-4">
                                <label @if( !$data['vti_details']['vti_scheme_of_study']) class="text-danger" @endif><strong>Scheme of Study:</strong></label>
                                <label>
