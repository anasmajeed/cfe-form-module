        ...
        <div class="card shadow p-3 w-100">
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        <label><strong>Receiving Date:</strong></label>
                        <label >
                            {{$data && $data['receiving_date'] ? $data['receiving_date'] : '--'}}
                        </label>
                    </div>
                    <div class="form-group col-md-4">
                        <label><strong>File Receipt Voucher No:</strong></label>
                        <label >
                ...
                <div class="form-row ">
                    <div class="form-group col-md-4">
                        <label><strong>PWWB Diary No:</strong></label>
                        <label >
                    ...
                    <div class="form-group col-md-4">
                        <label >
                        <label><strong>PWWB Diary Date:</strong></label>
                            {{$data && $data['pwwb_diary_date'] ? $data['pwwb_diary_date'] : '--'}}
                        </label>
                    </div>
                    <div class="form-group col-md-4">
                        <label><strong>Pending Files(With Remarks):</strong></label>
                        <label >
