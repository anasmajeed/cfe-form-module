                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <select  name="cell_status" class="form-control">
                                            <option value="yes" {{ $data && isset($data['eighth_semester_details']) ? $data['eighth_semester_details']['cell_status'] == 'yes' ? 'selected' : '' : ''}}>
                                                Yes</option>
                                            <option value="no" {{ $data && isset($data['eighth_semester_details']) ? $data['eighth_semester_details']['cell_status'] == 'no' ? 'selected' : '' : ''}}>
                                                No</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control text-center datepicker" name="cell_date"
                                               ...
                                               value="{{$data && isset($data['eighth_semester_details']) ? $data['eighth_semester_details']['cell_date'] : ''}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <select  name="pwwb_status" class="form-control">
                                    <option value="yes" {{ $data && isset($data['eighth_semester_details']) ? $data['eighth_semester_details']['pwwb_status'] == 'yes' ? 'selected' : '' : ''}}>
                                        Yes</option>
                                    <option value="no" {{ $data && isset($data['eighth_semester_details']) ? $data['eighth_semester_details']['pwwb_status'] == 'no' ? 'selected' : '' : ''}}>
                                        No</option>
                                </select>
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control text-center datepicker" name="pwwb_date"
                                       placeholder="yyyy-mm-dd"
                                       value="{{$data && isset($data['eighth_semester_details']) ? $data['eighth_semester_details']['pwwb_date'] : ''}}">
                            </div>
                            <div class="form-group col-md-3">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select  name="claim_status" class="form-control">
                                    <option value="yes" {{ $data && isset($data['eighth_semester_details']) ? $data['eighth_semester_details']['claim_status'] == 'yes' ? 'selected' : '' : ''}}>
                                        Yes</option>
                                    <option value="no" {{ $data && isset($data['eighth_semester_details']) ? $data['eighth_semester_details']['claim_status'] == 'no' ? 'selected' : '' : ''}}>
                                        No</option>
                                </select>
                            </div>
                            <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control text-center datepicker" name="claim_date"
                                       placeholder="yyyy-mm-dd"
                                       value="{{$data && isset($data['eighth_semester_details']) ? $data['eighth_semester_details']['claim_date'] : ''}}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow p-3 mt-1 w-100">
                    <div class="card-body" id="result_status_eighth_semester_parent">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <select  name="exam_status" class="form-control">
                                            <option value="yes" {{ $data && isset($data['eighth_semester_details']) ? $data['eighth_semester_details']['exam_status'] == 'yes' ? 'selected' : '' : ''}}>
                                                Yes</option>
                                            <option value="no" {{ $data && isset($data['eighth_semester_details']) ? $data['eighth_semester_details']['exam_status'] == 'no' ? 'selected' : '' : ''}}>
                                                No</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control text-center datepicker" name="exam_date"
                                               placeholder="yyyy-mm-dd"
                                               value="{{$data && isset($data['eighth_semester_details']) ? $data['eighth_semester_details']['exam_date'] : ''}}">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label>Amount:</label>
                        ...
                        <div class="form-row pt-2">
                            ...
                            <div class="form-row col-md-10 ml-0" id="result_status_eighth_semester_pass_headers" style="display: none">
                        ...
                        @if($data && isset($data['eighth_semester_result_status_details']) && count($data['eighth_semester_result_status_details']))
                            @foreach($data['eighth_semester_result_status_details'] as $eighthSemesterResultStatusDetails)
                                <div class="form-row mt-2" id="result_status_eighth_semester_div">
                                    ...
                                    <div class="col-md-10 form-row m-0" id="result_status_eighth_semester_pass_values" style="display: none">
                                        ...
                                        <div class="col-md-2 p-0">
                                            <input type="text" class="form-control text-center datepicker"
                                                   name="next_appearance_date[]" placeholder="yyyy-mm-dd" value="{{ $eighthSemesterResultStatusDetails['next_appearance_date']}}">
                                        </div>
                                        <div class="col-md-2 p-0">
                                            <input type="text" class="form-control text-center datepicker"
                                                   name="last_chance_date[]" placeholder="yyyy-mm-dd" value="{{ $eighthSemesterResultStatusDetails['last_chance_date']}}">
                                        </div>
                                        <div class="col-md-2 p-0">
                                            <input type="text" class="form-control text-center datepicker" name="passing_date[]"
                                                   placeholder="yyyy-mm-dd" value="{{ $eighthSemesterResultStatusDetails['passing_date']}}">
                                        </div>
                                    </div>
                                    <div class="col-md-1">
    ...
    <script>
        ...
        function setResultHeaderDisplayForEighthSemester() {
            ...
            $('.result_eighth_semester').each(function (index,value) {
                if($(value).val() == 'fail'){
                    $('#result_status_eighth_semester_pass_headers').show();
            ...
            if(check){
                $('#result_status_eighth_semester_pass_headers').hide();
            }
        }
    </script>
@endsection
