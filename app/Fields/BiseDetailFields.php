...
class BiseDetailFields
{
    ...
    const EDUCATIONAL_WING_CFE = 'educational_wing_cfe';
    const COURSE_APPLIED_IN = 'course_applied_in';
    const OPTIONAL_SUBJECT = 'optional_subject';
    const OTHERS = 'others';
    const COURSE_ENROLLED_CFE = 'course_enrolled_cfe';
    const COURSE_REGISTERED_IN = 'course_registered_in';
