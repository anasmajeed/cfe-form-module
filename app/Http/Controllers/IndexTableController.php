...
class IndexTableController extends Controller
{
    public function post(Request $request){
        ...
        $fileReceivedNumber = Arr::get($params,IndexTableFields::FILE_RECEIVED_NUMBER);
        ...
        $freshFileSubmissionInPwwbNumber = Arr::get($params,IndexTableFields::FRESH_FILE_SUBMISSION_IN_PWWB_NUMBER);
