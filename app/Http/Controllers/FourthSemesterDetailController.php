...
class FourthSemesterDetailController extends Controller
{
    public function post(Request $request)
    {
        ...
        $next_appearance_date_explode = explode('/',Arr::get($params,FourthSemesterResultStatusDetailFields::NEXT_APPEARANCE_DATE));
        ...
        $last_chance_date_explode = explode('/',Arr::get($params,FourthSemesterResultStatusDetailFields::LAST_CHANCE_DATE));
        ...
        $passing_date_explode = explode('/',Arr::get($params,FourthSemesterResultStatusDetailFields::PASSING_DATE));
    ...
    private function fillFourthSemesterResultStatusDetailData($index,$fourthSemesterResultStatusDetailObject,$index_id, $result, $fail, $next_appearance, $next_appearance_date, $last_chance_date, $passing_date){
        ...
        $fourthSemesterResultStatusDetailObject->next_appearance_date = isset($next_appearance_date[$index]) ? $next_appearance_date[$index] : null;
        $fourthSemesterResultStatusDetailObject->last_chance_date = isset($last_chance_date[$index]) ? $last_chance_date[$index] : null;
        $fourthSemesterResultStatusDetailObject->passing_date = isset($passing_date[$index]) ? $passing_date[$index] : null;
