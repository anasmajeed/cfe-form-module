...
Route::post('/eighth-semester','EighthSemesterDetailController@post');
...
Route::post('/eighth-semester-delete','EighthSemesterDetailController@deleteEighthSemesterResultStatusDetail');
